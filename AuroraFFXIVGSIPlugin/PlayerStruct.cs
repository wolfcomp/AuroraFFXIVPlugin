...
namespace AuroraFFXIVGSIPlugin
{
    ...
    {
        [JsonIgnore] public int EXP;
        [JsonIgnore] public byte Level;
        [JsonIgnore] public byte Job;
        ...
        public double LevelProgression => getEXPFromLevel(Level) > 0 ? EXP / getEXPFromLevel(Level) : 1;
        ...
        public PlayerStruct(CurrentPlayerResult currentPlayer, ActorItem playerActor)
        {
            ...
            Job = (byte) currentPlayer.CurrentPlayer.Job;
        ...
        private double getEXPFromLevel(byte level)
        {
            return level switch
            {
                1 => 300,
